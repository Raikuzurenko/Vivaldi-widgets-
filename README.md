...
Um the setup for this is similar and kinda stupid, just open a terminal and chanage directory to the folder where you've downloaded your GIF and just start a python web server that serves the download folder (or if you wanna be safer make another folder for this GIF only and serve that) by executing the command 
"python3 -m http.server 8000"
just change the port to any free port and in the file box paste "http://127.0.0.1:8000/dance.gif" replace the 8000 port number with your port that you chose earlier  and the "dance.gif" in the command with whatever name you saved the GIF as, you can also make it display images or videos , upto you lol. you could just ask chat gpt on how to make it auto start or just do what I do and start it every now and then whenever it breaks, its a janky setup but im lazy lowekey, regardless! Good luck if you have any problems, do ask and ill try and help as much as possible :) [here's the dance GIF](https://github.com/Raikuzurenko/Vivaldi-widgets-/blob/main/vivaldi_dark/readme_ss/dance.gif)

### TLDR: change directory in the termianl to where the GIF is downloaded and run "python3 -m http.server 8000" and in Vivaldi paste "http://127.0.0.1:8000/NAME_OF_YOUR_GIF.gif" and it should work :)

# FINAL NOTE(I swear): 
In vivaldi keep the widgets background style as transparent and if you wanna change the BG colour of the widget just ask chat gpt how to, by that I mean copy paste the code and tell it what colour you want the BG( background) or whatver to be and it will modify it for you.
