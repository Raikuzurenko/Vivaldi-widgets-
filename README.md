...
#### The stupid route:
the setup for this is similar and kinda stupid, just open a terminal and chanage directory to the folder where you've downloaded your GIF and just start a python web server that serves the download folder (or if you wanna be safer make another folder for this GIF only and serve that) by executing the command 
